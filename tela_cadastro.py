...
class SistemaCadastro:
    ...
    def criar_interface_cadastro(self):
        ...
        self.frame.place(relx=0.5, rely=0.5, anchor='center', relwidth=0.3, relheight=0.8)
    ...
    def criar_widgets_cadastro(self):
        ...
        self.botao_cadastrar = ctk.CTkButton(self, text="Cadastrar", command=self.cadastrar_paciente)
